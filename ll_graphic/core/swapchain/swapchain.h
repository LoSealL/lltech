...
********************************************************************/
#ifndef LL_GRAPHIC_CORE_SWAPCHAIN_SWAPCHAIN_H_
#define LL_GRAPHIC_CORE_SWAPCHAIN_SWAPCHAIN_H_
...
class SwapChain : public Object {
 public:
  ...
  virtual void Present(int vsync = 1) = 0;
...
#endif  // LL_GRAPHIC_CORE_SWAPCHAIN_SWAPCHAIN_H_
